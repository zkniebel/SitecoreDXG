...
var pretty = args.length > 3 ? args[3] : false;
...
var getGenerationSource = () => {
    ...
    var masterHelixDatabaseMap = new Documentation_Types.HelixDatabaseMap(
        ...
        new Documentation_Types.HelixLayerMap(
            ...
            "104E6124-706D-4620-9DB6-F8814BE5F471|6C3B2801-5573-40CF-87AD-A2CB94FCE40E|3DA20332-8D97-4B8C-BFE4-E482E68854EE"
                .toLowerCase()
                .split("|")));
        ...
        channel.assertQueue('', {
            ...
            channel.consume(q.queue, function(msg) {
                if (msg.properties.correlationId === generationId) {
                    var rawReply = msg.content.toString();
                    var output = pretty
                        ? JSON.stringify(JSON.parse(rawReply), null, 4)
                        : rawReply;
