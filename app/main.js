...
glob.sync(currentDirPath + "/plugins/completion_handlers/**{,!(node_modules)/**}*.js").forEach(function(file) {
...
glob.sync(currentDirPath + "/plugins/triggers/**{,!(node_modules)/**}*.js").forEach(function(file) {
